	...
	private function new()
	{
		...
		itemTemplates = [
			...
			new WeaponDTO({
				...
				fireDelay: 1.5, damage: 30, energy: 1,
				projectile: ProjectileProxy.cloneInstance().projectileTemplates[2]
			}),
			...
			new WeaponDTO({
				...
				fireDelay: 1.5, damage: 30, energy: 1,
				projectile: ProjectileProxy.cloneInstance().projectileTemplates[3]
			})
	];
	}
